...
export const Login: React.FC = () => {
  ...
  return (
    <section onSubmit={handleSubmit} className="bg-gray-200 h-full w-full">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="w-full bg-white rounded-lg shadow-2xl border sm:max-w-md">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            <svg
              className="w-106 h-42"
              viewBox="0 0 106 42"
              fill="none"
            ...
            <form className="space-y-4 md:space-y-6">
              <div>
                ...
                <input
                  ...
                  className="text-gray-900 bg-gray-200 sm:text-sm rounded-lg w-full p-2.5"
                />
              </div>

              <div>
                <label className="block mb-2 text-sm font-medium text-gray-900 text-white-100">
                  Password
                </label>
                <input
                  type="password"
              ...
              <button
                type="submit"
                className="w-full bg-blue-950 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-primary-600 hover:bg-primary-700 focus:ring-primary-800"
              >
                Sign in
              </button>
            </form>
